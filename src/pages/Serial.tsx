...
export default function Serial() {
  ...
  return (
    <div className="Movie flex flex-col gap-y-3 mb-14">
            ...
            <div className="meta-footer flex flex-col gap-y-3 w-full">
              ...
              <div className="flex justify-between items-center">
                <div className="metaScore leftside flex justify-center items-center gap-x-1.5">
                  <div className="flex justify-center items-center w-6 h-6 bg-orange-400 rounded-md">{result?.Metascore === "N/A" ? result?.Title.charCodeAt(0) : result?.Metascore}</div>
