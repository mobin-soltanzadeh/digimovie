...
export default function Movie() {
  ...
  return (
    <div className="Movie flex flex-col gap-y-3 mb-14 font-semibold">
      ...
      <div className="link flex flex-col justify-start items-start w-full lg:w-250 xl:w-300 mx-auto px-3 lg:px-0 mt-10 bg-gray-300 dark:bg-zinc-800 rounded-lg overflow- cursor-pointer" onClick={handleOpenModalA} >
