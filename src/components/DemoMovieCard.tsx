...
export default function DemoMovieCard({ movieIndex }: Props) {
  ...
  return (
    <Link to={"/digimovie/movies/"+movie.Title} className="DemoMovieCard relative flex flex-col justify-center gap-y-1 items-center group overflow-hidden">
      ...
      <div className="absolute -top-[20%] -left-64 group-hover:left-0 w-10 lg:w-12 xl:w-14 h-20 transition-[left]">
        <div className="relative">
          <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 68 341"><path fill-rule="evenodd" opacity="0.851" fill="rgb(0, 0, 0)" d="M0.005,-0.011 C0.041,1.280 0.072,2.584 0.072,4.005 C0.072,36.067 8.486,60.983 15.910,76.735 L57.177,133.667 C70.853,152.534 70.853,183.123 57.177,201.990 L26.908,243.749 L27.010,244.013 C27.010,244.013 0.072,278.915 0.072,336.920 C0.072,338.357 0.041,339.675 0.005,340.981 L0.005,-0.011 Z"></path> </svg>
