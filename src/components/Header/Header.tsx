            ...
            <div className="flex justify-center items-center gap-x-3 md:gap-x-6">
              ...
              <div className="group">
                ...
                <div className="absolute top-full hidden group-hover:flex pt-4 left-0 w-full text-gray-100" >
                  <div className={`actorModal flex justify-between items-center w-full h-64 px-4 bg-transparent/60 rounded-xl z-10 backdrop-blur-sm transition-opacity duration-500`}>
                    <div className="flex flex-col justify-end items-start gap-y-2 h-full mb-8">
                      <Link to="/digimovie/top-250-movies" className="flex justify-center items-center gap-x-1 hover:text-orange-400 transition-colors duration-300" > <span className="w-2 h-2 bg-orange-400 rounded-full"></span>Top 250 Movies</Link>
                      {/* <Link to="" className="flex justify-center items-center gap-x-1 hover:text-orange-400 transition-colors duration-300" > <span className="w-2 h-2 bg-orange-400 rounded-full"></span>All Movies (soon)</Link>
                      <Link to="/digimovie/boxoffice" className="flex justify-center items-center gap-x-1 hover:text-orange-400 transition-colors duration-300" > <span className="w-2 h-2 bg-orange-400 rounded-full"></span>Box Office</Link>
                      <Link to="" className="flex justify-center items-center gap-x-1 hover:text-orange-400 transition-colors duration-300" > <span className="w-2 h-2 bg-orange-400 rounded-full"></span>Animations (soon)</Link>
                      <Link to="" className="flex justify-center items-center gap-x-1 hover:text-orange-400 transition-colors duration-300" > <span className="w-2 h-2 bg-orange-400 rounded-full"></span>3D (soon)</Link> */}
                    </div>

                    <img className="h-full" src="https://digimovie160.sbs/wp-content/uploads/2021/05/09994db832d.png" alt="" />
                  </div>
                </div>
              </div>
              ...
              {/* Series Link */}
              <div className="group" >
                <LinkMenuItem title="Series" desc="Download Series" link="/digimovie/series"><svg className="fill-orange-400 group-hover:scale-125 transition-transform duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" id="tv"> <path d="M512 416.33V95H273.152l73.787-73.787L325.727 0 256 69.727 186.273 0 165.06 21.213 238.848 95H0v321.33h180.75V482h-46.819v30h241v-30H331.25v-65.67zm-482-30V125h452v261.33H180.75zM301.25 482h-90.5v-65.67h90.5z"></path> <path d="M455.67 144.74H56.33v219.19h399.34zm-30 189.19H86.33V174.74h339.34z"></path> <path d="M218.4 190.18v128.3l108.17-64.15zm30 52.67l19.36 11.48-19.36 11.48z"></path> </svg> </LinkMenuItem> 
              
                <div className="absolute top-full hidden group-hover:flex pt-4 left-0 w-full text-gray-100" >
                  <div className={`actorModal flex justify-between items-center w-full h-64 px-4 bg-transparent/60 rounded-xl z-10 backdrop-blur-sm transition-opacity duration-500`}>
                    <div className="flex flex-col justify-end items-start gap-y-2 h-full mb-8">
                      <Link to="" className="flex justify-center items-center gap-x-1 hover:text-orange-400 transition-colors duration-300" > <span className="w-2 h-2 bg-orange-400 rounded-full"></span>ops! not created yet (come back later)</Link>
                      {/* <Link to="" className="flex justify-center items-center gap-x-1 hover:text-orange-400 transition-colors duration-300" > <span className="w-2 h-2 bg-orange-400 rounded-full"></span>All Series (soon)</Link>
                      <Link to="" className="flex justify-center items-center gap-x-1 hover:text-orange-400 transition-colors duration-300" > <span className="w-2 h-2 bg-orange-400 rounded-full"></span>Anime (soon)</Link>
                      <Link to="" className="flex justify-center items-center gap-x-1 hover:text-orange-400 transition-colors duration-300" > <span className="w-2 h-2 bg-orange-400 rounded-full"></span>Mini Series (soon)</Link>
                      <Link to="" className="flex justify-center items-center gap-x-1 hover:text-orange-400 transition-colors duration-300" > <span className="w-2 h-2 bg-orange-400 rounded-full"></span>Ended Series (soon)</Link> */}
                    </div>

                    <img className="h-full" src="https://digimovie160.sbs/wp-content/uploads/2021/05/8-85266_breaking-bad-wallpaper-walter-white-y-jesse-pinkman-e1620044376536.png" alt="" />
                  </div>
                </div>
            ...
            <div className="flex justify-center items-center gap-x-3 md:gap-x-6" >
              ...
              <div className="group" >
                ...
                <div className="absolute top-full hidden group-hover:flex pt-4 left-0 w-full text-gray-100" >
                  <div className={`actorModal flex justify-between items-center w-full h-64 px-4 bg-transparent/60 rounded-xl z-10 backdrop-blur-sm transition-opacity duration-500`}>
                    <div className="flex flex-col justify-end items-start gap-y-2 h-full mb-8">
                      <Link to="/digimovie/actors/male/page=1" className="flex justify-center items-center gap-x-1 hover:text-orange-400 transition-colors duration-300" > <span className="w-2 h-2 bg-orange-400 rounded-full"></span> Best Actors</Link>
                      <Link to="/digimovie/actors/female/page=1" className="flex justify-center items-center gap-x-1 hover:text-orange-400 transition-colors duration-300" > <span className="w-2 h-2 bg-orange-400 rounded-full"></span> Best Actress</Link>
                      <Link to="/digimovie/directors" className="flex justify-center items-center gap-x-1 hover:text-orange-400 transition-colors duration-300" > <span className="w-2 h-2 bg-orange-400 rounded-full"></span> Best Directors</Link>
                    </div>

                    <img className="h-full" src="https://digimovie160.sbs/wp-content/uploads/2021/05/170a4cde698c1a599df988a597803520-e1621178227560.png" alt="" />
                  </div>
                </div>
