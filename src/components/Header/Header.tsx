...
export default function Header({onLogInOut}: Props) {
  return (
    ...
    <header className="Header flex flex-col gap-y-4 py-5 w-full">
      ...
      <section className="first-part flex justify-between items-center w-full lg:w-250 xl:w-300 mx-auto px-2">
        {/* logo & theme & likes */}
        <div className="left-side flex justify-center items-center gap-x-8">
          <SiteLogo />
          <ThemeLike />
        </div>
      ...
      <section className="second-part w-full bg-white dark:bg-neutral-800 px-2">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-y-3 w-full lg:w-250 xl:w-300 mx-auto py-4">

          <div className="flex justify-evenly lg:justify-center items-center gap-x-3 md:gap-x-6 w-full lg:w-auto px-5 lg:px-0">
