...
export default function MovieCard({ movie, type, dataAos, dataAosDuration, reset, setReset }: Props) {
  ...
  return (
    ...
    // <div data-aos={dataAos || ""} data-aos-duration={dataAosDuration || "2000"} className="flex flex-col md:flex-row justify-center items-center gap-4 w-full mx-auto md:w-4/5 md:mx-0 pt-4 pb-2 px-2 lg:p-4 bg-white dark:bg-neutral-800 rounded-lg">
