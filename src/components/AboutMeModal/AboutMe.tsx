...
export default function AboutMe() {
  ...
  return (
    <div className='fixed top-0 left-0 flex justify-center items-center w-screen h-screen z-[60]'>
      ...
      <ul className={`relative flex justify-center items-center w-4/5 max-w-250 h-[500px] mx-auto px-3 py-10 sm:p-10 -translate-x-3 bg-zinc-900 rounded-lg z-[70] ${lang==="en" ? "" : "font-dana-medium"} overflow--`}>
        {/* first slide */}
