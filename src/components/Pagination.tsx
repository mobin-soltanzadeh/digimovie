    ...
    <div className="BottomPagination flex justify-center items-center gap-x-3 w-full px-4 mb-10">
      ...
      }
      {
        ...
        pageNumbers.map(pageNum => (
          <button key={pageNum} className={`relative size-6 lg:size-7 xl:size-9 rotate-45 ${currentPage === pageNum && "bg-zinc-700 text-orange-500"} hover:bg-zinc-700 hover:text-orange-500 rounded-md`} onClick={() => (pageNum === -1 || pageNum === -2) ? 0 : setPage(+pageNum)} >
